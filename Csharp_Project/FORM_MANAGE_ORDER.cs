...
namespace Csharp_Project
{
    public partial class FORM_MANAGE_ORDER : Form
    {
        ...
        private void COMBO_CATEGORIES_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int val = Convert.ToInt32(COMBO_CATEGORIES.SelectedValue.ToString());
            ...
            {
                MessageBox.Show("DATABASE IS EMPTY", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
