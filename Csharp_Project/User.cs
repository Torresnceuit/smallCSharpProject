...
namespace Csharp_Project
{
    class User
    {
        ...
        public void updateUser(string username, string fullname, string type, string password, string tel, string email, int uid)
        {
            ...
            parameters[1] = new SqlParameter("@PASS", SqlDbType.VarChar, 20);
            parameters[1].Value = password;

            parameters[2] = new SqlParameter("@TYPE", SqlDbType.VarChar, 20);
            parameters[2].Value = type;

            parameters[3] = new SqlParameter("@FULL_NAME", SqlDbType.VarChar, 100);
            parameters[3].Value = fullname;

            parameters[4] = new SqlParameter("@TEL", SqlDbType.VarChar, 20);
            parameters[4].Value = tel;

            parameters[5] = new SqlParameter("@EMAIL", SqlDbType.VarChar, 20);
